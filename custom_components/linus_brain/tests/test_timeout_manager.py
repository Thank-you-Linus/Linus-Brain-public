...
class TestTimeoutManager:
    ...
    async def test_concurrent_different_keys(self, manager):
        ...
        manager.schedule(key="task1", delay=0.1, callback=timed_callback, task_key="task1")
        manager.schedule(key="task2", delay=0.1, callback=timed_callback, task_key="task2")
        manager.schedule(key="task3", delay=0.1, callback=timed_callback, task_key="task3")
